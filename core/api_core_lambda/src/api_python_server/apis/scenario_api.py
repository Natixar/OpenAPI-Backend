from .implementation import create_scenario as create_scenario_impl
from .implementation import delete_scenario as delete_scenario_impl
from .implementation import get_data as get_data_impl
from .implementation import get_scenario as get_scenario_impl
from .implementation import get_scenario_ranges as get_scenario_ranges_impl
from .implementation import list_scenarios as list_scenarios_impl
...
async def delete_scenario(scenarioId: str = Path(
    ...
    return await delete_scenario_impl(scenarioId=scenarioId)
...
async def list_scenarios() -> List[ListScenarios200ResponseInner]:
    """List all scenarios. The scenarios are returned in a list."""
    return await list_scenarios_impl()

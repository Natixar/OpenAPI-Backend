...
class ReleveDebut(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["date_releve", "raison_releve", "libelle_raison_releve", "qualite_releve", "statut_releve", "index_brut_debut", "index_converti_debut", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["date_releve", "raison_releve", "libelle_raison_releve", "qualite_releve", "statut_releve", "index_brut_debut", "index_converti_debut", ], str]):

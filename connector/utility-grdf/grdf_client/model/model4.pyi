...
class Model4(
    ...
    class MetaOapg:
        ...
        class properties:
            date_debut_consommation = schemas.DateSchema
            date_fin_consommation = schemas.DateSchema
            ...
            type_qualif_conso = schemas.StrSchema
            sens_flux_gaz = schemas.StrSchema
            statut_conso = schemas.StrSchema
            journee_gaziere = schemas.DateSchema
            type_conso = schemas.StrSchema
            __annotations__ = {
                "date_debut_consommation": date_debut_consommation,
                "date_fin_consommation": date_fin_consommation,
                "flag_retour_zero": flag_retour_zero,
                "volume_brut": volume_brut,
                "coeff_calcul": coeff_calcul,
                "volume_converti": volume_converti,
                "energie": energie,
                "type_qualif_conso": type_qualif_conso,
                "sens_flux_gaz": sens_flux_gaz,
                "statut_conso": statut_conso,
                "journee_gaziere": journee_gaziere,
                "type_conso": type_conso,
            }
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["date_debut_consommation"]) -> MetaOapg.properties.date_debut_consommation: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["date_fin_consommation"]) -> MetaOapg.properties.date_fin_consommation: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["type_qualif_conso"]) -> MetaOapg.properties.type_qualif_conso: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["sens_flux_gaz"]) -> MetaOapg.properties.sens_flux_gaz: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["statut_conso"]) -> MetaOapg.properties.statut_conso: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["journee_gaziere"]) -> MetaOapg.properties.journee_gaziere: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["type_conso"]) -> MetaOapg.properties.type_conso: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["date_debut_consommation", "date_fin_consommation", "flag_retour_zero", "volume_brut", "coeff_calcul", "volume_converti", "energie", "type_qualif_conso", "sens_flux_gaz", "statut_conso", "journee_gaziere", "type_conso", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["date_debut_consommation"]) -> typing.Union[MetaOapg.properties.date_debut_consommation, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["date_fin_consommation"]) -> typing.Union[MetaOapg.properties.date_fin_consommation, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["type_qualif_conso"]) -> typing.Union[MetaOapg.properties.type_qualif_conso, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["statut_conso"]) -> typing.Union[MetaOapg.properties.statut_conso, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["type_conso"]) -> typing.Union[MetaOapg.properties.type_conso, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["date_debut_consommation", "date_fin_consommation", "flag_retour_zero", "volume_brut", "coeff_calcul", "volume_converti", "energie", "type_qualif_conso", "sens_flux_gaz", "statut_conso", "journee_gaziere", "type_conso", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        date_debut_consommation: typing.Union[MetaOapg.properties.date_debut_consommation, str, date, schemas.Unset] = schemas.unset,
        date_fin_consommation: typing.Union[MetaOapg.properties.date_fin_consommation, str, date, schemas.Unset] = schemas.unset,
        ...
        type_qualif_conso: typing.Union[MetaOapg.properties.type_qualif_conso, str, schemas.Unset] = schemas.unset,
        sens_flux_gaz: typing.Union[MetaOapg.properties.sens_flux_gaz, str, schemas.Unset] = schemas.unset,
        statut_conso: typing.Union[MetaOapg.properties.statut_conso, str, schemas.Unset] = schemas.unset,
        journee_gaziere: typing.Union[MetaOapg.properties.journee_gaziere, str, date, schemas.Unset] = schemas.unset,
        type_conso: typing.Union[MetaOapg.properties.type_conso, str, schemas.Unset] = schemas.unset,

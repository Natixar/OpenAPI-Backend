...
class Model5(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def injection() -> typing.Type['Injection']:
                return Injection
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["injection"]) -> 'Injection': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["pce", "periode", "releve_debut", "releve_fin", "injection", "bordereau_publication", "statut_restitution", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["injection"]) -> typing.Union['Injection', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["pce", "periode", "releve_debut", "releve_fin", "injection", "bordereau_publication", "statut_restitution", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        injection: typing.Union['Injection', schemas.Unset] = schemas.unset,

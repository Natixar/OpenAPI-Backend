...
from grdf_client.paths.pce_id_pce_donnees_injections_publiees.get import GetPceIdPceDonneesInjectionsPubliees


class DonnesDinjectionApi(
    GetPceIdPceDonneesInjectionsPubliees,
):

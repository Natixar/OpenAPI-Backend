...
class IdPceSchema(
    ...
    pass
SchemaFor200ResponseBodyApplicationXNdjson = ConsoRestit
...
class BaseApi(api_client.Api):
    ...
    def _get_pce_id_pce_donnees_consos_informatives_oapg(
        self: api_client.Api,
...
class GetPceIdPceDonneesConsosInformatives(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def get_pce_id_pce_donnees_consos_informatives(
        self: BaseApi,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        ...
        return self._get_pce_id_pce_donnees_consos_informatives_oapg(

...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'filtre': typing.Union[FiltreSchema, list, tuple, ],
    },
    total=False
)
...
request_query_filtre = api_client.QueryParameter(
    name="filtre",
...
SchemaFor200ResponseBodyApplicationJson = GetPceIdPceDonneesContractuelles200Response
...
SchemaFor400ResponseBodyApplicationJson = GetPceIdPceDonneesContractuelles400Response
...
SchemaFor500ResponseBodyApplicationJson = GetPceIdPceDonneesContractuelles500Response
...
class BaseApi(api_client.Api):
    ...
    def _get_pce_id_pce_donnees_contractuelles_oapg(
        self: api_client.Api,
...
class GetPceIdPceDonneesContractuelles(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def get_pce_id_pce_donnees_contractuelles(
        self: BaseApi,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        ...
        return self._get_pce_id_pce_donnees_contractuelles_oapg(
